...
$sql_check = "SELECT * FROM cart WHERE user_id = ? AND model_id = ? AND variant_id = ? AND product_name = ?";
...
$stmt_check->bind_param("iiis", $user_id, $model_id, $variant_id, $product_name);
...
if ($result_check->num_rows > 0) {
    ...
    // If the product doesn't exist, insert a new record into the cart
